...
public class Level2Enemy : MonoBehaviour
{
    ...
    public Level2EnemyCollider EnemyColliderScript;
        ...
        if (EnemyColliderScript.Enemy_Health > 0)
        {
            ...
            else if (_state==Enemy_State.patrol)
            {
                ...
                else
                {
                    ...
                    if (Vector3.Distance(PatrolList[Patrol_index].transform.position, EnemyChild.transform.position) >1.5f)
                    {
                        _nav.SetDestination(PatrolList[Patrol_index].transform.position);
                    }
                    else
